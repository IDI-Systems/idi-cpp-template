...
int @__idi_app_namespace@_@__idi_app_namespace@_get_version_major() {
    return common::get_version_major();
}

int @__idi_app_namespace@_@__idi_app_namespace@_get_version_minor() {
    return common::get_version_minor();
}

int @__idi_app_namespace@_@__idi_app_namespace@_get_version_patch() {
