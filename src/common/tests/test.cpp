...
TEST_CASE("Git information are correctly set and returned.", "[common]") {
    SECTION("Internal API calls.") {
        REQUIRE_THAT(@__idi_vendor_namespace@::@__idi_app_namespace@::common::get_git_hash_short(),
          Catch::Equals(IDI_VERSION_GIT_HASH_SHORT));
        REQUIRE_THAT(@__idi_vendor_namespace@::@__idi_app_namespace@::common::get_git_hash_long(),
        ...
        REQUIRE(@__idi_vendor_namespace@::@__idi_app_namespace@::common::get_git_is_dirty() == static_cast<bool>(IDI_VERSION_GIT_DIRTY));
        REQUIRE_THAT(@__idi_vendor_namespace@::@__idi_app_namespace@::common::get_build_timestamp(),
