...
macro(idi_init)
    ...
    set("${__idi_c_caps_namespace}_IS_SHARED" ${IDI_IS_SHARED})

    set("${__idi_c_caps_namespace}_PROJECT_NAME" ${IDI_PROJECT_NAME})
    set("${__idi_c_caps_namespace}_PROJECT_NAME_STR" ${IDI_PROJECT_NAME_STR})
    set("${__idi_c_caps_namespace}_IS_LIBRARY" ${IDI_IS_LIBRARY})
    set("${__idi_c_caps_namespace}_IS_SHARED" ${IDI_IS_SHARED})
    set("${__idi_c_caps_namespace}_IS_DYNAMIC" ${IDI_IS_DYNAMIC})
    set("${__idi_c_caps_namespace}_VENDOR_NAMESPACE" ${IDI_VENDOR_NAMESPACE})
    set("${__idi_c_caps_namespace}_APP_NAMESPACE" ${IDI_APP_NAMESPACE})
