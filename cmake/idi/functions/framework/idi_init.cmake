...
macro(idi_init)
    ...
    set(IDICMAKE_DECONFLICT_MULTIPLE 0 CACHE BOOL "This is forced to false for now no matter the project setting, may be deprecated.")
    ...
    if(NOT (TARGET "${IDICMAKE_PROJECT_NAME}_${__idi_version_full}"))
        ...
        #     while(IDICMAKE_DEFERRED_LIB_LIST)
        #         list(GET IDICMAKE_DEFERRED_LIB_LIST 0 var)
        ...
        #         message(STATUS "CUUUUUUUR ${IDICMAKE_DEFERRED_LIB_LIST}")
        #         list(POP_FRONT IDICMAKE_DEFERRED_LIB_LIST)
        #     endwhile()
        # endif()
    endif()
endmacro()
