...
function(__idi_copy_template component_name src_dir dest_dir)
    ...
    foreach(template_file ${template_files})
        ...
        if(NOT IS_DIRECTORY ${src_template_path})
            ...
            __idi_copy_template(${component_name} ${src_template_path} ${dest_dir}/${template_file}/${IDI_PROJECT_NAME})
            else()
...
macro(idi_new_component)
    ...
    if(NEW_COMPONENT_NAME)
        ...
        set(template_src_dir "${PROJECT_SOURCE_DIR}/cmake/templates/template_component")
